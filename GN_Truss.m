...
% of top boundary UDLs a rectangular system of truss elements
...
function [x_sol,fval,it] = GN_Truss(q,Ly,weight,A,elem,coords,dofs,dofs_free,forces,tol,maxIt,lambda)
