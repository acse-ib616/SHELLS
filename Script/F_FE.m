...
% This function assembles the external nodal forces vector F given a mesh
% and geometric and material constants for the CST, LST and truss elements
...
% Outputs:
% - F: external nodal forces vector
