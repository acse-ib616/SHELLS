...
public:
    void operator()(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs)
    {
        ...
        uint32_t element_type = inputs[4][0];                               // Type of element
        ...
        if (element_type == 1)
        {
            Jacobian_CST(Ly, q, node_coords, ELEMENTS, col_index, row_position, values);
        }
        else if (element_type == 2)
        {
            Jacobian_LST(Ly, q, node_coords, ELEMENTS, col_index, row_position, values);
        }
        else
        {
            Jacobian_Truss(Ly, q, node_coords, ELEMENTS, col_index, row_position, values);
        }
    ...
    // This function assembles the Jacobian matrix in sparse CSR format for the CST element
    void Jacobian_CST(double Ly, std::vector<double> q, std::vector<double> node_coords, std::vector<uint32_t> ELEMENTS, std::vector<uint32_t> &col_index, std::vector<uint32_t> &row_position, std::vector<double> &values)
    {
        ...
        uint32_t n1, n3, dof12, dof32;           // Element DOFs
    ...
    void Jacobian_LST(double Ly, std::vector<double> q, std::vector<double> node_coords, std::vector<uint32_t> ELEMENTS, std::vector<uint32_t> &col_index, std::vector<uint32_t> &row_position, std::vector<double> &values)
    {
    ...
    void Jacobian_Truss(double Ly, std::vector<double> q, std::vector<double> node_coords, std::vector<uint32_t> ELEMENTS, std::vector<uint32_t> &col_index, std::vector<uint32_t> &row_position, std::vector<double> &values)
    {
    ...
    // Check that right input arguments are fed to the MEX function
    void checkArguments(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs)
    {
        ...
        {
            matlabPtr->feval(u"error",
                             0, std::vector<matlab::data::Array>({factory.createScalar("2nd input must be one-dimensional matrix")}));
        }
        ...
        {
            matlabPtr->feval(u"error",
                             0, std::vector<matlab::data::Array>({factory.createScalar("2nd input matrix must be type double")}));
        }
        ...
        if (inputs[3].getType() != matlab::data::ArrayType::UINT32 ||
            inputs[3].getType() == matlab::data::ArrayType::COMPLEX_UINT32)
        {
            matlabPtr->feval(u"error",
                             0, std::vector<matlab::data::Array>({factory.createScalar("4th input matrix must be type uint32")}));
        }
        ...
        {
            matlabPtr->feval(u"error",
                             0, std::vector<matlab::data::Array>({factory.createScalar("5th input must be a scalar")}));
        }
        ...
        {
            matlabPtr->feval(u"error",
                             0, std::vector<matlab::data::Array>({factory.createScalar("5th input must be a scalar type uint32")}));
        }
    }
};
